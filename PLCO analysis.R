...
##              competing event (y2). m.y0 and m.y2 are based on n.y1
##              - design weights 
##
...
##
##              Results are displayed in Section 6 in the Main Document. For the 
##              additional analyses displayed in the Web Appendices (with m.y0 
##              and m.y2 based on n.y0 and n.y2, respectively), see Rscript in 
##              PLCO supplementary analysis.R 
## -----------------------------------------------------------------------------
